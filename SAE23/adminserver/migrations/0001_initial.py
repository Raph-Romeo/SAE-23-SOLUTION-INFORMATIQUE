    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_de_lancement', models.DateField(default=django.utils.timezone.now, max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('espace_memoire_utilise', models.IntegerField()),
                ('memoire_vive_necessaire', models.IntegerField()),
                ('serveurs', models.ManyToManyField(to='adminserver.serveurs')),
                ('services_utilises', models.ManyToManyField(to='adminserver.services')),
