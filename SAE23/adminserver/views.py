...
def serveur_pdf(request,id):
    ...
    pdf.cell(200,10, txt="Le serveur " + serveur.nom + " est un serveur de type " + models.type_de_serveurs.objects.get(pk=serveur.type_de_serveur_id).type,ln = 2, align = 'C')
    pdf.cell(200, 10, txt="Espace stockage: " + str(serveur.stockage) + "Mo", ln=4,align='C')
    pdf.cell(200, 10, txt="Espace restant: " + str(serveur.stockage - count_server_storage(serveur,"","")) + "Mo", ln=5,align='C')
    pdf.cell(200, 10, txt="Memoire vive: " + str(serveur.memoire) + "Mo", ln=6, align='C')
    pdf.cell(200, 10, txt="Memoire vive non occupée: " + str(serveur.memoire - count_server_memory(serveur, "", "")) + "Mo",ln=7, align='C')
